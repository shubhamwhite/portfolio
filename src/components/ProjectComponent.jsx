...
const ProjectComponent = () => {
  ...
  return (
    <div className="project-bg w-full h-screen flex flex-col items-center justify-center xl:pt-90 md:pt-20 border-t-2 border-gray-700">
      ...
      <div className="flex justify-center items-center w-full max-w-6xl mt-4 px-3">
        <div onClick={goToPrevious} className="cursor-pointer mr-2">
          <img 
            src={leftArrow} 
            alt="Previous" 
        ...
        <div onClick={goToNext} className="cursor-pointer ml-2">
          <img 
            src={rightArrow} 
            alt="Next" 
            className="h-10 w-10 md:h-20 md:w-20 hover:opacity-75 transition duration-300" 
